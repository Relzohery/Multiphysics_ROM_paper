...
The effort described extends previous work\cite{elzohery2021exploring} aimed to develop and assess a ROM framework that can be used for different purposes, such as design optimization and propagating input parameter uncertainties like nuclear data.
