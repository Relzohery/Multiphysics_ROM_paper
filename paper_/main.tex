...
%\title{Application of the Matrix version of DEIM and POD-Galerkin projection 
...
Where applications of the ROM to the diffusion equation have been introduced before \cite{}, this work focuses on treating the non-linearity induced by coupling with different physics.
Previous work has used the DEIM to approximate non-linear fielsa such as the temperature \cite{german2019application}.
